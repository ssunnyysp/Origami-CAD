...
class GeometryRequest(BaseModel):
    ...
    gridDivisions: int = Field(ge=5, le=15)  # N; solver cost/residual grows
    # fast with ring count (rings = (N-1)/2), so this stays well inside the
    # range validated by scripts/validate_flasher.py rather than left open.
